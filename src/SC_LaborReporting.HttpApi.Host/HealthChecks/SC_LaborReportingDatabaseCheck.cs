...
public class SC_LaborReportingDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public SC_LaborReportingDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
