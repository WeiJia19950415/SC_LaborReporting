...
namespace SC_LaborReporting.Migrations
{
    ...
    [Migration("20260915114616_UpdateAttendanceData")]
    partial class UpdateAttendanceData
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SC_LaborReporting.AttendanceDatas.AttendanceData", b =>
                {
                    b.Property<Guid>("Id")
                    ...
                    b.Property<string>("AttendanceTeam")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("CheckInResults")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("OffdutytimeResults")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("SC_LaborReporting.Books.Book", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SC_LaborReporting.LaborCategories.LaborCategoryProjectRole", b =>
                {
                    b.Property<Guid>("LaborCategoryId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasKey("LaborCategoryId", "ProjectRoleId");

                    b.ToTable("AppLaborCategoryProjectRoles", (string)null);
                });

            modelBuilder.Entity("SC_LaborReporting.LaborReports.LaborReport", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<decimal>("TotalEffectiveHours")
                    ...
                    b.ToTable("AppLaborReports", (string)null);
                });

            modelBuilder.Entity("SC_LaborReporting.LaborReports.LaborReportApprovalRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("LaborReportDetailId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("LaborReportApprovalRecords");
                });

            modelBuilder.Entity("SC_LaborReporting.LaborReports.LaborReportApprovalStatus", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("LaborReportApprovalStatus");
                });

            modelBuilder.Entity("SC_LaborReporting.LaborReports.LaborReportDetail", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<double>("Hoursfinance")
                        .HasColumnType("float");
                    ...
                    b.Property<string>("LaborCategoryCode")
                        .IsRequired()
                        .HasMaxLength(64)
                    ...
                    b.HasIndex("LaborReportId");

                    b.ToTable("AppLaborReportDetails", (string)null);
                });

            modelBuilder.Entity("SC_LaborReporting.ProductSeries.ProductSeries", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppProductSeries", (string)null);
                });

            modelBuilder.Entity("SC_LaborReporting.ProjectRoles.ProjectRole", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppProjectRoles", (string)null);
                });

            modelBuilder.Entity("SC_LaborReporting.Projects.Project", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SC_LaborReporting.LaborReports.LaborReportDetail", b =>
                {
                    b.HasOne("SC_LaborReporting.LaborReports.LaborReport", "LaborReport")
                        .WithMany("Details")
                        .HasForeignKey("LaborReportId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("LaborReport");
                });
